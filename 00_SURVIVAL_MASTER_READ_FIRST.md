...
Branch: `AIL_SIGMA`
Status: MANDATORY FOR SURVIVAL / INTERNET AUTOLEARN CONTINUATION
Date: 2026-09-17

If a chat/window/context ended and you need to continue the current Survival + Internet-autolearn work, DO NOT rediscover the repository from scratch.

Read exactly:

1. `SURVIVAL_MASTER/CURRENT_HANDOFF.md`
2. `SURVIVAL_MASTER/REQUESTS/20260917_INTERNET_AUTO_BUNDLE_IMPLEMENTATION_REQUEST_R1.md`
3. `SURVIVAL_MASTER/REQUESTS/20260917_INTERNET_AUTO_BUNDLE_SUBMISSION_TEMPLATE_R1.md`
...
7. `/AGENTS.md` and its native-execution directives.
...
IMPLEMENTER_MUST_STOP_AFTER_GITHUB_SUBMISSION=YES
HUMAN_MUST_NOT_INSTALL_BEFORE_SURVIVAL_MASTER_REVIEW=YES
STATIC_REVIEW_CAN_UNLOCK=OPPO_PREFLIGHT_ONLY
PRODUCTION_ENABLEMENT_FROM_STATIC_REVIEW=NO
```
