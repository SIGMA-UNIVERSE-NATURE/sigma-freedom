...
## CURRENT V4/V5 PERSISTENT-KNOWLEDGE LANE FLAG — LEVEL 1 COMPLETE / V5-K1 SOURCE READY
...
`SIGMA_PROFESSOR/DIRECTIVES/TEACHER_GPT_GITHUB_PROGRESS_HANDOFF_POLICY_V1.md`

Current exact state from the latest machine evidence:
...
Do not ask the user to restate the V4/V5 journey if these repository files provide the needed context. Continue from the living handoff `NEXT ACTION` and preserve `CLAIM <= MACHINE EVIDENCE`.
