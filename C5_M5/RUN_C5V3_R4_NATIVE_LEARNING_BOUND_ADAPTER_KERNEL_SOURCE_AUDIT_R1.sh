...
printf '%s\n' '=== C5V3 R4 BOUND ADAPTER + ONE-CYCLE KERNEL SOURCE AUDIT R1 ==='
...
echo "ADAPTER_R3_COMMIT_BOUND=YES"
echo "KERNEL_R2_COMMIT_BOUND=YES"
