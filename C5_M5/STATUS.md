...
- Gate A — M5 TEST: cognition/memory -> continual learning -> revision/support/conflict -> new independent blind tests.
...
Gate B runs independently. Gate A does not add tools. Production binding remains NO.
