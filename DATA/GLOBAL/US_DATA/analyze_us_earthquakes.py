...
# Dự báo Poisson (λ = 28 trận/tháng cho M≥4.5, điều chỉnh theo tỉ lệ)
# Ước tính λ cho từng ngưỡng dựa trên tỉ lệ từ dữ liệu Đông Nam Á
# Giả định: tỉ lệ M≥4.5 / M≥3.5 ≈ 0.2
lambda_base = 28  # cho M≥4.5
lambda_est = {
    3.5: lambda_base * 5,   # ước tính tỉ lệ
    4.0: lambda_base * 2.5,
    4.5: lambda_base,
    5.0: lambda_base * 0.3,
    5.5: lambda_base * 0.1,
