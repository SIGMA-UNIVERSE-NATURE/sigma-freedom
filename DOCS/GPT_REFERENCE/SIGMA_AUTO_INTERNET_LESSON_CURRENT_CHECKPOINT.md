...
A new GPT window must continue only from `CURRENT_FRONTIER`. Do not spend context re-finding hashes, re-running V4–V8, or asking the user to repaste historical handoff unless machine evidence contradicts this checkpoint.
...
Host must NOT choose semantic query/source winner, truth, relevance, lesson quality, evidence sufficiency, knowledge conclusion, or research-replan decision on Sigma's behalf.
...
V9_REPLAN_ENGINE_SHA256=3813a4422944173d7f8811e139f247cf546a2e88f8716117b56114c2c46a3cbb
```

All proven tools are PRESERVE. Identity mismatch => STOP; never silently rebuild/replace and continue as the same runtime/tool.
...
Minimum thresholds are policy inputs. Semantic/philosophical evidence sufficiency is not proven.
...
V7 proves an extractive grounded candidate only. Raw candidate exposed weak/off-target lexical material and malformed Web markup.

### V8 — candidate evidence-support assessment — CANONICAL PASS

```text
PACKAGE=/data/data/com.termux/files/home/SIGMA/sigma_genesis1/.sigma_exec/HH_AUTO_INTERNET_LESSONS/V1_R11_SIGMA_NATIVE_CANDIDATE_SUPPORT_ASSESSOR
...
SUPPORT_RUN=/data/data/com.termux/files/home/SIGMA/sigma_genesis1/.sigma_exec/HH_AUTO_INTERNET_LESSONS/candidate_support_assessments/20260902T024553Z_13409_14243
SOURCE_KNOWLEDGE_RUN=/data/data/com.termux/files/home/SIGMA/sigma_genesis1/.sigma_exec/HH_AUTO_INTERNET_LESSONS/knowledge_candidates/20260902T015922Z_29525_18467
...
MALFORMED_SURFACE=1
UNKNOWN=0
DISTINCT_SUPPORTED_SOURCES=0
SUPPORTED_CANDIDATE_BYTES=0
ASSESSMENT_SHA256=47cb0bc1d350fd5dd3b7461bace84e564b46dd71ed85dbc24f6a502dd9413aac
SUPPORTED_CANDIDATE_SHA256=e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855
...
SUPPORT_STATE_READBACK_CMP_RC=0
RAW_BINDING_FAILURES=0
V7_BEFORE_AFTER_CMP_RC=0
V5_CORPUS_BEFORE_AFTER_CMP_RC=0
...
`NO_SUPPORTED_FOR_TOPIC` is a valid negative Sigma assessment, not a failed capability.
...
Because V8 returned `NO_SUPPORTED_FOR_TOPIC`, the current next capability is Sigma-native research replan, not conflict analysis.

```text
CURRENT_FRONTIER=SIGMA_NATIVE_RESEARCH_REPLAN_FROM_SUPPORT_FAILURE_V9
CURRENT_STATUS=V9_OPPO_INSTALL_QA_PASS_READY_FOR_LIVE
```
...
V9 is decision-only. It does NOT yet execute a new Internet collection cycle. A later stage will connect an emitted `RESEARCH_MORE` action back to preserved query/Internet collection capabilities.

The V9 engine contains no target-specific query, source, or answer. Host may validate action vocabulary and provenance but must not derive the replan action from V8 metrics.

### V9 OPPO install QA — PASS

Installed package:

```text
PACKAGE=/data/data/com.termux/files/home/SIGMA/sigma_genesis1/.sigma_exec/HH_AUTO_INTERNET_LESSONS/V1_R12_SIGMA_NATIVE_RESEARCH_REPLAN
INSTALLER_FILE=INSTALL_SIGMA_NATIVE_RESEARCH_REPLAN_V9_ADDITIVE.sh
INSTALLER_SHA256=fb67031912e808ad83272bc894ec4f1c971575132977092c663046cc7a4f0d55
...
HOST_ROLE=MECHANICAL_PROVENANCE_VERIFIER_ONLY
...
READY_TO_RUN_NATIVE_RESEARCH_REPLAN=YES
```

### V9 live acceptance gate

Before canonical V9 PASS require at minimum:
...
After live summary, independently inspect raw VM ledger, raw action/reason/strategy outputs, readbacks, source support-state/metrics bindings, exact research-topic readback, provenance, and V8 immutability before canonicalizing.

Do not claim closed-loop autonomous learning until a Sigma replan decision is actually connected back through fresh Internet collection and produces a new V6→V7→V8 evidence cycle.
...
V14 closed autonomous learning cycle
V15 backup/Git/GitHub lifecycle + survival integration
```

---

## 6. NEXT WINDOW ENTRY POINT
...
4. Accept V9 OPPO install QA as PASS and preserve V9 bytecode identity.
5. Do not rerun or rediscover V4–V8 or reinstall V9 without a new root cause.
6. Continue with the V9 live replan run only.

```text
NEXT_COMMAND=RUN_V9_LIVE_REPLAN
NEXT_PACKAGE=/data/data/com.termux/files/home/SIGMA/sigma_genesis1/.sigma_exec/HH_AUTO_INTERNET_LESSONS/V1_R12_SIGMA_NATIVE_RESEARCH_REPLAN
NEXT_RUNNER=99_RUN_SIGMA_NATIVE_RESEARCH_REPLAN_V9.sh
V9_REPLAN_BYTECODE_SHA256=3813a4422944173d7f8811e139f247cf546a2e88f8716117b56114c2c46a3cbb
```
