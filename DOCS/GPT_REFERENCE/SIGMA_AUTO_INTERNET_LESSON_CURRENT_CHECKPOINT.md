...
R4R1 correctly preserved UNKNOWN when the host resource observation failed the exact enum contract; do not count it as a cognitive failure.

## V16 R4R2 OPPO INSTALL/COMPILE QA — CANONICAL PASS

```text
CURRENT_FRONTIER=SIGMA_NATIVE_OUTCOME_CONDITIONED_QUERY_EVOLUTION_V16
CURRENT_STATUS=V16_R4R2_OPPO_INSTALL_COMPILE_QA_PASS_READY_FOR_LIVE
...
R4R1_UNKNOWN_RESOURCE_FAILURE_PRESERVED=YES
...
HOST_RESOURCE_ENUM_EXACT_BYTES_QA=PASS
HOST_RESOURCE_ENUM_TRAILING_LINEBREAK=NO
...
NEXT_COMMAND=RUN_V16_R4R2_LIVE_WITH_EXPLICIT_CANONICAL_V15_R2_RUN
