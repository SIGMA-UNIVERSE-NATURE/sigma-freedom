...
## DNA-16 Experience-Driven Learning — source ready / not admitted
...
CHECKPOINT=SIGMA_PROFESSOR/CHECKPOINTS/20260905_DNA16_NATIVE_ADMISSION_SOURCE_READY.md

Expected admission suite if execution reaches completion:
16 directed + 32 randomized + 2 byte-identical replay = 50 VM invocations.
...
NEXT_TARGET=RUN DNA-16 NATIVE ADMISSION V1 FULL 50-CASE SUITE
PLANNED_NEXT_IF_PASS=INSPECT DNA-17 Two Levels of Learning exact dependencies
