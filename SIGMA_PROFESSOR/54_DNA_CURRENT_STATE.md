...
V1 source line 226 was a bare `{` opening the main body. FIX1 changed only that line to explicit `⟡(Σ.DNA10_MEMORY_GENOME_NATIVE_V1) {` and then compiled and passed all 50 runtime cases. Causal statement is restricted to this exact source/compiler delta.
