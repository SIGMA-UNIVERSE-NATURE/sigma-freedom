...
SRC="$E/SIGMA_DOCUMENT_SURVEY_V2_5A_1.sigma"
BC="$E/SIGMA_DOCUMENT_SURVEY_V2_5A_1.sigmab"
EXPECTED_SOURCE=210b1227f2805ddd460f95db89dd71258f84ba5a892aa5b50787cea84cf3eb85
...
printf 'SIGMA_PHASE=V25A_1_DOCUMENT_SURVEY_PREFLIGHT\n'
...
if [ "$PASS" -eq 1 ] && [ "$SURVEYED_COUNT" -eq 3 ] && [ "$RECORD_COUNT" -eq 3 ] && [ "$COMPLETE_SEEN" -eq 1 ]; then
    printf 'V25A_1_DOCUMENT_SURVEY_PREFLIGHT=PASS\n'
    printf 'NEXT_ACTION=BUILD_V25_FULL_CORPUS_SURVEY_RUNNER\n'
    exit 0
fi

printf 'V25A_1_DOCUMENT_SURVEY_PREFLIGHT=FAIL\n'
