...
BASE="$HOME_SIGMA/SIGMA_V4C3T1_NATIVE_CLOCK_PERSISTENCE_PREFLIGHT"
...
REL="SIGMA_PROFESSOR/artifacts/SIGMA_V4_NATIVE_CLOCK_PERSISTENCE_PROBE_V4C3T1.sigma"
EXPECTED_BLOB=4d6cbf449108294d3a084fefa5167a5215e01748
REPO_SRC="$REPO/$REL"
SRC="$E/SIGMA_V4_NATIVE_CLOCK_PERSISTENCE_PROBE_V4C3T1.sigma"
BC="$E/SIGMA_V4_NATIVE_CLOCK_PERSISTENCE_PROBE_V4C3T1.sigmab"
PREV="$E/SIGMA_V4C3T1_PREVIOUS_TIME.memory"
STATUS="$E/SIGMA_V4C3T1_STATUS.memory"

mkdir -p "$E" "$LOG"

exec 9>"$LOCK"
if ! "$P/bin/flock" -n 9; then
    printf 'HOLD=V4C3T1_CLOCK_PREFLIGHT_ALREADY_RUNNING\n'
    exit 20
fi
...
VM_SHA=$(hash1 "$VM")
printf 'SIGMA_PHASE=V4C3T1_NATIVE_CLOCK_PERSISTENCE_PREFLIGHT\n'
...
printf '\nV4C3T1_NATIVE_CLOCK_PERSISTENCE_PREFLIGHT=PASS\n'
...
printf 'NATIVE_TIME_PERSISTENCE_ROUNDTRIP=PASS_IN_TWO_OBSERVATION_SCOPE\n'
printf 'NATIVE_TIME_PROGRESS_DECISION=PASS_IN_TWO_OBSERVATION_SCOPE\n'
printf 'HOST_TIME_DECISION=NO\n'
printf 'ONE_HOUR_DUTY_CYCLE=NOT_YET_PROVEN\n'
printf 'TEN_MINUTE_REST_CYCLE=NOT_YET_PROVEN\n'
printf 'NEXT_ACTION=BUILD_V4C3_NATIVE_DUTY_CYCLE_AND_REPORTER\n'
